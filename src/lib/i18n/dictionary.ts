...
export const dict = {
  EN: {
    ...
    home: {
      ...
      // Copy for the promo tile that leads the featured grid.
      browseKicker: "Full catalog",
      browseTitle: "New stock lands every week",
      browseBlurb: "Turbos, cartridges and fitting parts, all in one place.",
      browseCta: "Browse all",
      factEst: "Established",
      factEstVal: "2014",
  ...
  KA: {
    ...
    home: {
      ...
      browseKicker: "სრული კატალოგი",
      browseTitle: "ახალი მარაგი ყოველ კვირას",
      browseBlurb: "ტურბოები, კარტრიჯები და დამხმარე ნაწილები, ერთ ადგილას.",
      browseCta: "ყველას ნახვა",
      factEst: "დაარსდა",
      factEstVal: "2014",
